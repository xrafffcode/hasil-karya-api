...
class ProjectAPITest extends TestCase
{
    ...
    public function test_project_api_call_create_with_auto_code_and_some_drivers_and_some_truck_and_some_stations_and_some_checkers_expect_success()
    {
        $user = User::factory()
            ->hasAttached(Role::where('name', '=', UserRoleEnum::ADMIN)->first())
            ->create();
        ...
        $project['code'] = $response['data']['code'];
        $project = Arr::except($project, ['drivers', 'trucks', 'stations', 'checkers']);
    ...
    public function test_project_api_call_update_with_auto_code_and_some_drivers_and_some_truck_and_some_stations_and_some_checker_expect_success()
    {
        $user = User::factory()
            ->hasAttached(Role::where('name', '=', UserRoleEnum::ADMIN)->first())
            ->create();
        ...
        $updatedProject['code'] = $response['data']['code'];
        $updatedProject = Arr::except($updatedProject, ['drivers', 'trucks', 'stations', 'checkers']);
